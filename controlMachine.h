...
//checkBox_lenth   but_startZhang  opcWriteDataParameter2
				 ...
				 try{
					 ...
					 for(i = 0 ; i < genHoleCount; i++)
					 {
						 ...
						 if(  (System::Convert::ToSingle(this->str_holeInfo[ temp + 3]) > 0) && ( totalLen  > 0 ) ) {
							 ...
							 totalLenDis =((int)( ( totalLenDis ) / System::Convert::ToSingle(this->str_holeInfo[ temp + 3]) *10000)) / 10000.0;
