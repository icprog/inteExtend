...
#define DRAW_DATA_BUFF (4095*10) 
	...
	private: System::Int32 absReadOpcIndex;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->toolStripStatusLabel5->Size = System::Drawing::Size(155, 17);
			...
			this->pictureBox_Mpa1->Location = System::Drawing::Point(16, 83);
			this->pictureBox_Mpa1->Name = L"pictureBox_Mpa1";
			this->pictureBox_Mpa1->Size = System::Drawing::Size(367, 280);
			this->pictureBox_Mpa1->TabIndex = 21;
			this->pictureBox_Mpa1->TabStop = false;
			this->pictureBox_Mpa1->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &historyForm::pictureBox_Mpa1_Paint);
			// 
			// pictureBox_MM1
			// 
			this->pictureBox_MM1->BackColor = System::Drawing::SystemColors::ButtonHighlight;
			this->pictureBox_MM1->Location = System::Drawing::Point(16, 371);
			this->pictureBox_MM1->Name = L"pictureBox_MM1";
			this->pictureBox_MM1->Size = System::Drawing::Size(367, 280);
			this->pictureBox_MM1->TabIndex = 22;
			this->pictureBox_MM1->TabStop = false;
			this->pictureBox_MM1->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &historyForm::pictureBox_MM1_Paint);
			// 
			// panel2
			// 
			...
			this->pictureBox_Mpa2->Location = System::Drawing::Point(16, 83);
			this->pictureBox_Mpa2->Name = L"pictureBox_Mpa2";
			this->pictureBox_Mpa2->Size = System::Drawing::Size(367, 280);
			this->pictureBox_Mpa2->TabIndex = 20;
			this->pictureBox_Mpa2->TabStop = false;
			this->pictureBox_Mpa2->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &historyForm::pictureBox_Mpa2_Paint);
			// 
			// pictureBox_MM2
			// 
			this->pictureBox_MM2->BackColor = System::Drawing::SystemColors::ButtonHighlight;
			this->pictureBox_MM2->Location = System::Drawing::Point(16, 371);
			this->pictureBox_MM2->Name = L"pictureBox_MM2";
			this->pictureBox_MM2->Size = System::Drawing::Size(367, 280);
			this->pictureBox_MM2->TabIndex = 21;
			this->pictureBox_MM2->TabStop = false;
			this->pictureBox_MM2->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &historyForm::pictureBox_MM2_Paint);
			// 
			// but_play
			// 
...
private: System::Void pictureBox_Mpa1_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
	...
	fMpa = (int )(drawDataHis[absReadOpcIndex > 0 ? absReadOpcIndex - 1:0].Mpa * 100 ) / 100.0;
...
private: System::Void pictureBox_MM1_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
	...
	fMm = (int )(drawDataHis[absReadOpcIndex > 0 ? absReadOpcIndex - 1:0].Mm * 100 ) / 100.0;
...
private: System::Void pictureBox_Mpa2_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
	...
	fMpa = (int )(drawDataHis[absReadOpcIndex > 0 ? absReadOpcIndex - 1:0].Mpa2 * 100 ) / 100.0;
...
private: System::Void pictureBox_MM2_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
	...
	fMm = (int )(drawDataHis[absReadOpcIndex > 0 ? absReadOpcIndex - 1:0].Mm2 * 100 ) / 100.0;
...
private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e) {
	...
	if( intervalTime > 1000  || absReadOpcIndex - absReadOpcIndex_pre > 5){
		intervalTime = 0;
