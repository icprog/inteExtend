...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->toolStripStatusLabel5->Text = L"湖南聚创建筑科技有限公司2.16.6";
			// 
			// linkLabel1
			// 
					...
					//if(  (connectStatus == true) )
							 ...
							 //if(p_comBase->opcReadData!=nullptr)
							   //降低界面刷新率
								 ...
								 if(this->p_comBase->opcReadData[4] && this->p_comBase->opcReadData[4]->Quality  == 192) { //位移
								 ...
								 if(this->p_comBase->opcReadData[4] && this->p_comBase->opcReadData[5]->Quality  == 192){ //油压
									 tempData2 =  System::Convert::ToSingle( this->p_comBase->opcReadData[5]->DataValue );
									 //if( timeTickCount % 5 == 0) 
									 this->label_d1Mpa->Text = Round_float( tempData2 ,2);
								 }

								 if(this->p_comBase->opcReadData[4] && this->p_comBase->opcReadData[SINGLE_OPC_NUM + 4]->Quality  == 192) { //位移
								 ...
								 if(this->p_comBase->opcReadData[4] && this->p_comBase->opcReadData[SINGLE_OPC_NUM + 5]->Quality  == 192){ //油压
								 ...
								 if(ZhangLaStatus == ZHANGLA_RUN)		{
									 ...
									 if( (listBox2Noticed & 2) || (listBox2Noticed & 1) ) {
										 ...
										 if(this->p_comBase->opcReadData[4] && this->p_comBase->opcReadData[1]->Quality  == 192) //保压合格时间  
										 ...
										 if( this->p_comBase->opcReadData[4] )
								 ...
								 if(this->p_comBase->opcReadData[4] && this->p_comBase->opcReadData[2]->Quality  == 192) { //控制力值
								 ...
								 if(this->p_comBase->opcReadData[4] && this->p_comBase->opcReadData[3]->Quality  == 192) { //油压目标值
								 ...
								 if(this->p_comBase->opcReadData[4] && this->p_comBase->opcReadData[SINGLE_OPC_NUM + 2]->Quality  == 192){ //控制力值
								 ...
								 if(this->p_comBase->opcReadData[4] && this->p_comBase->opcReadData[SINGLE_OPC_NUM + 3]->Quality  == 192){  //油压目标值
